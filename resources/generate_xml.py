...
def generate_xml(input_file, random_seed, rooms, areas, pedestrian_names, agents, ensemble, checkpoint,
	...
	with open(input_file, "w") as configuration_file:
		...
		# Da mettere * 2 una votla sistemati i length sottostanti
		...
		# Da definire e usare sotto, sol_length va bene solo per intermediate targets e stay
		# Prendere la dimensione massima tra tutti gli agenti esistenti per ogni length
		# flow_length =
		# hours_schedule_length =
		# birth_rates_length =
		# event_length =
