...
def generate_xml(input_file, random_seed, rooms, areas, pedestrian_names, agents, ensemble, checkpoint,
	...
	with open(input_file, "w") as configuration_file:
		...
		num_rooms_types = len(WHOLEmodel["types"])
		...
		with open("agents_file.xml", "w") as agent_file:
			...
			for agent_name, agent_info in agents.items():
				...
				env_vaccination_end_of_immunization_distr[agent_type_idx] = float(agent_whatif.iloc[0]["vaccination_end_of_immunization"])
				env_vaccination_end_of_immunization_distr_firstparam[agent_type_idx] = float(agent_whatif.iloc[0]["vaccination_end_of_immunization"])
				env_vaccination_end_of_immunization_distr_secondparam[agent_type_idx] = float(agent_whatif.iloc[0]["vaccination_end_of_immunization"])
