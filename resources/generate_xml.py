...
def generate_xml(input_file, random_seed, rooms, areas, pedestrian_names, agents, ensemble, checkpoint,
	...
	with open(input_file, "w") as configuration_file:
		...
		autogenerated_variables_names.write("#define NODE_WAITING_FOR_EVENT \"node_waiting_for_event\"\n\n")
		autogenerated_variables_names.write("#define NODE_STARTING_FROM_EVENT\"node_starting_from_event\"\n\n")
