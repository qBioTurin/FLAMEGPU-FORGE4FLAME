...
#define CHEBYSHEV_DISTANCE(x1, x2, y1, y2) (max(abs((x1)-(x2)), abs((y1)-(y2))))


#define MAP_DIM_X 32 //TOTALLY TODO MODIFY in autogenerated
#define MAP_DIM_Y 32 // TOTALLY TO DO MODIFY in autogenerated
#define GRID_SIZE (MAP_DIM_X * MAP_DIM_Y)
